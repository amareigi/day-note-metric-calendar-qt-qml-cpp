    ...
    ListView {
        ...
        delegate: MyMonth {
            ...
            onDayClicked: function(monthIndex, dayIndex) {
                ...
                // console.log("Year:dayCliced, index:", dayIndex);
                // console.log("Year:monthIndex:", monthIndex);
                // console.log("Year:displayedYear:", root.displayedYear);
                // console.log("Year:selectedDate:", root.selectedDate);
                // console.log("Year:newSelectedDate:", newSelectedDate);
            }
        }
